...
export class RedisConfig {
   ...
   */
  static getDefaultTTL(configService: ConfigService): number {
    return configService.get<number>('REDIS_TTL', 3600);
  }
  ...
  static isEnabled(configService: ConfigService): boolean {
    return configService.get<boolean>('REDIS_ENABLED', true);
  }
}
